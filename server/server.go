...
func (s *Server) Routes(btc utils.BaseTemplateContext) {
	...
	s.Router.Get("/swimming/styles", s.handleRequest(meetController.MeetModalitiesView))
	s.Router.Get("/swimming/styles/:stroke/", s.handleRequest(meetController.MeetModalityView))
